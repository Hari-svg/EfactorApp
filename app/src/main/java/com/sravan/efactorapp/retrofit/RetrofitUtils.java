...
// MultipartBody.Part is used to send also the actual file name
    ...
    public static MultipartBody.Part createEmptyFilePart(String variableName, MediaType mediaType) {
// create RequestBody instance from file
        RequestBody requestFile =
                RequestBody.create(mediaType, "");
// MultipartBody.Part is used to send also the actual file name
        return MultipartBody.Part.createFormData(variableName, "", requestFile);
    }
